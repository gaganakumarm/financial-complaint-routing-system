...
from app.models import DeploymentCandidate, DeploymentCandidateStatus, ModelPromotionStatus
...
class DeploymentCandidateService:
    def __init__(self, candidate_repository: DeploymentCandidateRepository, promotion_repository: ModelPromotionRepository) -> None:
    ...
    async def create_candidate(self, value: DeploymentCandidateCreateInput) -> DeploymentCandidate:
        ...
        return await self._persist_new(candidate)
    ...
    async def stage_candidate(self, value: DeploymentCandidateStageInput) -> DeploymentCandidate:
        ...
        return await self._flush_reload(candidate)
    ...
    async def _persist_new(self, candidate: DeploymentCandidate) -> DeploymentCandidate:
        try:
            await self._candidates.add_candidate(candidate); await self._candidates.flush()
    ...
    async def _flush_reload(self, candidate: DeploymentCandidate) -> DeploymentCandidate:
        try:
