...
def test_service_imports_exports_and_resource_isolation() -> None:
    ...
    expected_benchmark_exports |= {
        ...
        "DeploymentCandidateActivateInput",
        "DeploymentCandidateConsistencyError",
        "DeploymentCandidateCreateInput",
        "DeploymentCandidateNotFoundError",
        "DeploymentCandidatePersistenceError",
        "DeploymentCandidateRejectInput",
        "DeploymentCandidateRetireInput",
        "DeploymentCandidateService",
        "DeploymentCandidateServiceError",
        "DeploymentCandidateStageInput",
        "DeploymentCandidateStateConflictError",
        "DuplicateDeploymentCandidateError",
        "InvalidDeploymentCandidateError",
        "PromotionDecisionNotApprovedError",
